...
app.get('/products', function(req,res) {
    console.log("Consultando products en api");
    respuesta = {
        error : false,
        codigo: 200,
        mensaje: items
...
app.get('/product/:id',jsonParser, function(req,res) {
    console.log("Consultando products id en api: " + req.params.id );
...
app.delete('/product/:id',jsonParser, function(req,res) {
    console.log("Id que se desea eliminar: " ,req.params.id);
    console.log("items: ",items);
    console.log("se eliminara ",items[req.params.id]);

    let index = items.indexOf(items[req.params.id]);    
    if (index > -1) {
